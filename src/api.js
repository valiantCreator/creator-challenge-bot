...
// Gemini: Updated Health Check to focus on Process Uptime (DB doesn't need warming with short-lived connections).
...
function startServer(client) {
  ...
  // --- Gemini: NEW Health Check for UptimeRobot ---
  // Since we use short-lived DB connections, we don't need to query the DB to keep it "warm".
  // This simply confirms the Node.js process is up and running.
